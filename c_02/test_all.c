...
int	main(void)
{
	...
	assert_int(0, ft_str_is_numeric("1 2"), "ft_str_is_numeric 4");
	// ----------------
	...
	assert_int(0, ft_str_is_lowercase("1 2"), "ft_str_is_lowercase 4");
	// ----------------
	...
	assert_int(0, ft_str_is_uppercase("1 2"), "ft_str_is_uppercase 4");
	// ----------------
	assert_int(0, ft_str_is_printable("aaadasdbsdaczAZA\n"),
		"ft_str_is_printable 0");
	assert_int(0, ft_str_is_printable("\7F\n"), "ft_str_is_printable 0");
	assert_int(1, ft_str_is_printable("a123asd"), "ft_str_is_printable 1");
	assert_int(1, ft_str_is_printable(""), "ft_str_is_printable 2");
	assert_int(1, ft_str_is_printable("AASDASDADQWQVSCXWEC"),
		"ft_str_is_printable 3");
	assert_int(1, ft_str_is_printable("123958213"), "ft_str_is_printable 4");
	assert_int(1, ft_str_is_printable("1 2"), "ft_str_is_printable 4");
	// ---------------
